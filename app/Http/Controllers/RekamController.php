...
class RekamController extends Controller
{
    ...
    {
        $rekam = Rekam::with('pasien', 'dokter', 'diagnosaPrimer')->orderBy('id', 'DESC')->paginate(15);
    ...
    public function show($id)
    {
        ...
        $obats = Obat::all();
        $diagnosa = \App\Models\MasterDiagnosa::all();
        return view('rekam.show', compact('rekam', 'prescription', 'obats', 'diagnosa'));
    }
